...
function t12() {
    ...
    a.innerHTML = 'Hello' + ' ' + name + ' ' + surname; 
}
...
function t13() {
    ...
    b = +b.value;
    let c = document.querySelector('.out-13');
    c.innerHTML = a + b;
}
...
function t15() {
    let a = document.querySelector('.i-15').style.border = "4px solid red";
}
...
function t16() {
    ...
    let c = document.querySelector('.out-16');
