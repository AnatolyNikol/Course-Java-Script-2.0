...
function f7() {
   ...
   let c = document.querySelector('.out-7').innerHTML = Math.pow(a, b);
}
...
function f10() {
   ...
   let b = document.querySelector('.out-10').innerHTML = a;
}
...
function f11() {
   ...
   let b = document.querySelector('.out-11').innerHTML = a;
}
...
function f14() {
   ...
   let d = document.querySelector('.out-14');
...
function f15() {
   ...
   let d = document.querySelector('.out-15');

   if (a == '1' && b == '1' && c == '&&') {
      d.innerHTML = 1;
   }
   else if (a == '1' && b == '0' && c == '||' || a == '0' && b == '1' && c == '||' || a == '1' && b == '1' && c == '||') {
      d.innerHTML = 1;
   }
   else {
      d.innerHTML = 0;
